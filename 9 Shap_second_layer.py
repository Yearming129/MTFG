...
def main():
    # 1. Load data
    file_path = r'F:\Python file\2020\Shap_2020.csv'
    data = pd.read_csv(file_path, encoding='utf-8')

    # 2. Data preprocessing
    X = data[['CLCD', 'long', 'lat', 'Wind', 'Sun', 'Sand', 'Clay', 'Silt', 'Slope',
    ...
    # 3. Load model
    model_path = r'F:\SHAP\xgb_2020_shap.json'
    xgb_model = xgb.XGBRegressor()
    xgb_model.load_model(model_path)
    print("The model has been loaded successfully!")

    # 5. Analysis of SHAP interpretability
    output_dir = r'F:\SHAP_Second\2020'
    ...
    output_csv_path = os.path.join(output_dir, 'shap_2020_second.csv')
